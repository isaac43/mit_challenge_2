...
COPY submission_isaac.py utils.py /app/
COPY trained_model/model_by_timestamp.cbm /trained_model/model_by_timestamp.cbm
...
CMD ["conda", "run", "-n", "orekit_venv_v12", "python", "submission_isaac.py"]
